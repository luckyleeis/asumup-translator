...
function extractTranslatedSentences(response) {
  return response.result.translations.reduce(
...
const agent = {
  https: new socksProxyAgent.SocksProxyAgent("socks5://127.0.0.1:9050"),
  http: new socksProxyAgent.SocksProxyAgent("socks5://127.0.0.1:9050")
};
...
function splitIntoSentences(text, sourceLanguage, identifier) {
  return __async(this, null, function* () {
    return extractSplitSentences(
      yield splitSentences(text, sourceLanguage, identifier)
    );
  });
}
...
function translate(_0, _1) {
  return __async(this, arguments, function* (text, targetLanguage, sourceLanguage = AUTO, identifier, alternatives, formalityTone) {
    ...
    return extractTranslatedSentences(
      yield requestTranslation(
        text,
        abbreviateLanguage(targetLanguage),
        (_a = abbreviateLanguage(sourceLanguage)) != null ? _a : "auto",
        identifier,
        alternatives,
        formalityTone
      )
